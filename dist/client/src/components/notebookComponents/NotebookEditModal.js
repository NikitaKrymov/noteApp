...
const NotebookCreateModal = (props) => {
    ...
    const [description, setDescription] = react_1.useState(props.description);
    ...
    return (react_1.default.createElement(ModalDiv_1.default, { style: { top: '20%', gridTemplateRows: '2fr 2fr 8fr 1fr' } },
        ...
        react_1.default.createElement(FlexBox_1.default, { theme: BOTTOM_FLEXBOX_THEME },
            ...
            react_1.default.createElement(PrimaryButton_1.default, { theme: SUBMIT_BUTTON_THEME, onClick: () => { props.closeModal(false); title.length > 0 ? props.saveNotebook(notebookId, { title, description, owner: userId }) : setTitleError(true); } }, "Save"))));
};
