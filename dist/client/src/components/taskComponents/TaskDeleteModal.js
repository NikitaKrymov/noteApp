...
const Modal = (props) => {
    return (react_1.default.createElement(ModalDiv_1.default, { style: { top: '8em', height: '10em', gridTemplateRows: '1fr 1fr' } },
        react_1.default.createElement(FlexBox_1.default, { theme: TOP_FLEXBOX_THEME }, "Are you sure you want to delete this task?"),
...
//# sourceMappingURL=TaskDeleteModal.js.map