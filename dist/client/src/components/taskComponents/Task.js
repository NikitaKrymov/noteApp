...
var Input_1 = __importDefault(require("../../elements/Input"));
    ...
    if (editMode) {
        return (react_1.default.createElement(TaskEditModeTrue_1.default, null,
            react_1.default.createElement(FlexBox_1.default, null,
                react_1.default.createElement(Input_1.default, { value: taskSubject, onChange: function (e) { return setTaskSubject(e.target.value); } })),
